...
// LGUI(KC_X) / KC_CUT: cut
// LGUI(KC_C) / KC_COPY: copy
// LGUI(KC_V) / KC_PASTE: paste
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT_ortho_3x10(
    ...
    OS_LCTL, OS_LALT, OS_LGUI, KC_GRV,  _______, KC_TAB,  KC_BSLS, KC_COMM, KC_DOT,  KC_SLSH
  ),
  ...
  [_LOWER] = LAYOUT_ortho_3x10(
    ...
    KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,  _______, OS_LGUI, OS_LALT, OS_LCTL, KC_CAPS
  ),
